...
public class SolutionTest {
    ...
    public void testSort() {
        String[] array = new String[] {"abcd", "abc", "a", "dcdadd", "bcdad"};
        Arrays.sort(array);
    ...
    public void testIsPredecessor() {
        assertTrue(solution.isPredecessor("bad", "bfad"));
    }

    @Test
    public void testIsPredecessor_2() {
        assertTrue(solution.isPredecessor("abcd", "abcde"));
    }

    @Test
    public void testIsPredecessor_3() {
        assertFalse(solution.isPredecessor("cba", "bcad"));
    }

    @Test
    public void testLongestStrChain() {
        assertEquals(2, solution.longestStrChain(new String[] {"bad", "bfad"}));
    }

    @Test
    public void testLongestStrChain2() {
        assertEquals(3, solution.longestStrChain(new String[] {"bad", "bfad", "bfada"}));
    }

    @Test
    public void testLongestStrChain4() {
        assertEquals(4, solution.longestStrChain(new String[] {"bad", "bfad", "bfafdfas","bfada", "bfadas"}));
    }

    @Test
    public void testLongestStrChain5() {
        assertEquals(4, solution.longestStrChain(new String[] {"a","b","ba","bca","bda","bdca"}));
    }

    @Test
    public void testLongestStrChain6() {
        assertEquals(5, solution.longestStrChain(new String[] {"xbc","pcxbcf","xb","cxbc","pcxbc"}));
    }

    @Test
    public void testLongestStrChain7() {
        assertEquals(15, solution.longestStrChain(arr));
    }

    @Test
    public void testLongestStrChain8() {
        assertEquals(7, solution.longestStrChain(new String[] {"ksqvsyq","ks","kss","czvh","zczpzvdhx","zczpzvh","zczpzvhx","zcpzvh","zczvh","gr","grukmj","ksqvsq","gruj","kssq","ksqsq","grukkmj","grukj","zczpzfvdhx","gru"}));
    }
